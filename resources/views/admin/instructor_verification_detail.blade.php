            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        @if($verification->user->profile_image)
                    ...
                    <h5 class="text-center mb-3">{{ $verification->user->name }}</h5>
                    
                    <div class="mb-3">
                        <p class="mb-1 small text-muted">Email</p>
                        <p class="mb-0">{{ $verification->user->email }}</p>
                    </div>
                    
                    <div class="mb-3">
                        <p class="mb-1 small text-muted">Phone</p>
                        <p class="mb-0">{{ $verification->user->phone ?? 'Not provided' }}</p>
                    </div>
                    
                    <div class="mb-3">
                        <p class="mb-1 small text-muted">Joined</p>
                        <p class="mb-0">{{ $verification->user->created_at ? $verification->user->created_at->format('M d, Y') : 'Not available' }}</p>
                    </div>
                    
                    @if($verification->user->bio)
                        <div class="mb-0">
                    ...
                    <form action="{{ route('admin.instructor.verification.process', $verification->id) }}" method="POST">
                        ...
                        <div class="mb-4 rejection-reason" style="display: none;">
                            ...
                            <textarea class="form-control @error('rejection_reason') is-invalid @enderror" 
                                      id="rejection_reason" name="rejection_reason" rows="4">{{ old('rejection_reason') }}</textarea>
