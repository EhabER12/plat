            ...
            <form action="{{ route('admin.coupons.update', $coupon->coupon_id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('max_uses') is-invalid @enderror" id="max_uses" name="max_uses" value="{{ old('max_uses', $coupon->max_uses) }}" min="1">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('valid_to') is-invalid @enderror" id="valid_to" name="valid_to" value="{{ old('valid_to', $coupon->valid_to ? $coupon->valid_to->format('Y-m-d') : '') }}">
                        @error('valid_to')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('minimum_order_amount') is-invalid @enderror" id="minimum_order_amount" name="minimum_order_amount" value="{{ old('minimum_order_amount', $coupon->minimum_order_amount) }}" step="0.01" min="0">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check mt-4">
                            <input class="form-check-input" type="checkbox" value="1" id="is_active" name="is_active" {{ old('is_active', $coupon->is_active) ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    @foreach($courses as $course)
                                        <div class="col-md-4 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input course-checkbox" type="checkbox" value="{{ $course->course_id }}" id="course_{{ $course->course_id }}" name="courses_applicable[]" 
                                                {{ (is_array(old('courses_applicable')) && in_array($course->course_id, old('courses_applicable'))) || 
                                                   (is_array($coupon->courses_applicable) && in_array($course->course_id, $coupon->courses_applicable)) ? 'checked' : '' }}>
