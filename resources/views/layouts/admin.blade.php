    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-primary text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush sidebar-nav">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="list-group-item list-group-item-action p-3 bg-transparent text-white border-0 dropdown-toggle {{ request()->routeIs('admin.badges*') || request()->routeIs('admin.achievements*') ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#gamificationSubmenu" aria-expanded="{{ request()->routeIs('admin.badges*') || request()->routeIs('admin.achievements*') ? 'true' : 'false' }}">
                        <i class="fas fa-trophy me-2"></i> Gamification
                    </a>
                    <div class="collapse {{ request()->routeIs('admin.badges*') || request()->routeIs('admin.achievements*') ? 'show' : '' }}" id="gamificationSubmenu">
                        <a href="{{ route('admin.badges.index') }}" class="list-group-item list-group-item-action py-2 ps-5 bg-transparent text-white border-0 {{ request()->routeIs('admin.badges*') ? 'active' : '' }}">
                            <i class="fas fa-award me-2"></i> Badges
                        </a>
                        <a href="{{ route('admin.achievements.index') }}" class="list-group-item list-group-item-action py-2 ps-5 bg-transparent text-white border-0 {{ request()->routeIs('admin.achievements*') ? 'active' : '' }}">
