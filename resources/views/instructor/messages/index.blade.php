                ...
                <div class="overflow-y-auto h-[calc(100%-80px)]">
                    @if($contacts->isEmpty())
                        <div class="flex flex-col items-center justify-center h-full text-gray-500 p-6">
                            ...
                            <p class="text-center mt-2">You haven't exchanged messages with any students yet.</p>
                        </div>
                    @else
                        @foreach($contacts as $contact)
                            <div class="hover:bg-gray-50 {{ $selectedContact && $selectedContact->user_id == $contact->user_id ? 'bg-blue-50' : '' }}" 
            ...
            <div class="hidden md:flex flex-col w-2/3 lg:w-3/4">
                ...
                @else
                    ...
                    <div class="p-4 border-t border-gray-200">
                        <form action="{{ route('instructor.messages.send') }}" method="POST" class="flex items-center">
                            @csrf
