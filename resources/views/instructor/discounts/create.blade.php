...
<div class="container-fluid">
    <div class="mb-4">
        <a href="{{ route('instructor.discounts.index') }}" class="btn btn-outline-primary">
            ...
            <form action="{{ route('instructor.discounts.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="Enter discount name">
                        @error('name')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('discount_value') is-invalid @enderror" id="discount_value" name="discount_value" value="{{ old('discount_value') }}" step="0.01" min="0" required placeholder="Enter discount value">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" id="applies_to_all_courses" name="applies_to_all_courses" {{ old('applies_to_all_courses') ? 'checked' : '' }}>
                            <label class="form-check-label" for="applies_to_all_courses">
                                Apply to all my courses
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mb-4" id="coursesSection">
                        ...
                        <p class="text-muted small">Select which of your courses this discount applies to.</p>
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-check">
